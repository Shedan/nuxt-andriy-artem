<template>
    <form id="contact-form" class="text-sm">
        <div class="flex flex-col">
            <label for="name" class="mb-3">_ім'я:</label>
        ...
        <div class="flex flex-col">
            <label for="message" class="mb-3">_повідомлення:</label>
            <textarea id="message-input" name="message" :placeholder="message" class="placeholder-slate-600" required></textarea>
        </div>
        <button id="submit-button" type="submit" class="py-2 px-4">відправити</button>
    </form>
</template>
