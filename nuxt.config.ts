  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Тут могла бути ваша реклама' },
        { hid: 'og:title', property: 'og:title', content: siteTitle },
        { hid: 'og:description', property: 'og:description', content: 'Тут могла бути ваша реклама' },
        { hid: 'og:image', property: 'og:image', content: 'demo-share.jpg' },
        { hid: 'og:url', property: 'og:url', content: 'https://it-security-aa.netlify.app/' },
